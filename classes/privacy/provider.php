 ...
 *
 * Declares local pending-context rows and user preferences, plus conversation
 * data transferred to the Dixeo API. Export and erasure of conversations are
 * implemented here via local_dixeo's tutor_service.
 *
...
/**
 * Privacy provider for tutor conversations and local tutor state.
 *
 * Conversations live in the Dixeo API, keyed by course, user and site namespace.
 * The block also stores queued proactive context in block_dixeo_tutor_pending and
 * user preferences for read state and tutor mode. Conversation methods below are a
 * translation from Moodle privacy vocabulary to {@see tutor_service}.
 *
