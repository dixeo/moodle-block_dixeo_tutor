...
$string['privacy:metadata:pendingpurpose'] = 'Almacena mensajes proactivos del tutor en cola hasta que se envían a la API de Dixeo.';
...
$string['proactive_first_visit'] = 'Es la primera vez que abro este curso. Envíame un mensaje de bienvenida.';
