...
$string['guide_completion_exit'] = 'Salir';
$string['guide_completion_restart'] = 'Iniciar una nueva sesión';
$string['guide_review_back'] = 'Volver a la conversación';
$string['guide_review_session'] = 'Revisar sesión';
$string['guide_setup_cancel'] = 'Cancelar';
$string['guide_setup_error'] = 'No se pudo iniciar el modo guía. Inténtalo de nuevo.';
$string['guide_setup_instructions'] = 'En el modo Guíame, el tutor usa un diálogo socrático: hace preguntas para que razones el tema en lugar de recibir primero la respuesta. Describe abajo en qué necesitas ayuda y responde con tus propias palabras durante la sesión.';
$string['guide_setup_prompt'] = '¿En qué necesitas orientación?';
$string['guide_setup_prompt_placeholder'] = 'Por ejemplo: no entiendo cómo funciona la fotosíntesis…';
$string['guide_setup_start'] = 'Iniciar sesión';
$string['guide_setup_starting'] = 'Preparando tu sesión socrática…';
$string['guide_setup_title'] = 'Guíame';
$string['guide_topic_label'] = 'Sesión guiada';
...
$string['practice_quiz_label'] = 'Cuestionario de práctica';
...
$string['proactive_guide_started'] = 'El alumno acaba de entrar en el modo socrático (Guíame). Ha indicado en qué necesita ayuda: «{$a->userprompt}». Resume esto en guideTopic.title y guideTopic.description. Inicia un diálogo socrático centrado en esa necesidad con el contenido del curso: formula una pregunta concreta que requiera respuesta. No des una lección ni la respuesta completa. Espera a que el alumno responda.';
...
$string['quiz_review_ai_instructions'] = '[Revisión del cuestionario de práctica] El alumno terminó el cuestionario de práctica «{$a->title}» con una mejor puntuación de {$a->score}/{$a->total}. Reconoce brevemente su resultado y anímalo. No revises preguntas individuales, no listes respuestas correctas ni des feedback sobre respuestas concretas. Nunca recomiendes este cuestionario de práctica ni el título «{$a->title}» — lo genera el tutor y no es un módulo de Moodle. OBLIGATORIO: tu respuesta DEBE incluir exactamente un siguiente paso concreto que nombre una actividad o recurso Moodle existente copiando su nombre exacto de la estructura del curso anterior. No inventes nombres. No termines solo con una línea de puntuación.';
...
$string['quiz_review_details'] = 'Ver resultados del cuestionario';
