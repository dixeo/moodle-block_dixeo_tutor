...
$string['proactive_return_visit_delighted'] = 'Sto continuando questo corso oggi. Inviami un saluto particolarmente caloroso ed entusiasta — allegro e motivante. Non fare riferimento alla mia assenza, al tempo trascorso o al fatto che sto tornando. Concentrati nel salutarmi e incoraggiarmi a continuare il corso.';
$string['proactive_return_visit_enthusiastic'] = 'Sto continuando questo corso oggi. Inviami un saluto caloroso e vivace, con energia positiva. Non menzionare quanto tempo sono stato assente né usare formule come « bentornato » — salutami e aiutami a riprendere da dove avevo lasciato.';
$string['proactive_return_visit_warm'] = 'Sto continuando questo corso oggi. Inviami un breve saluto cordiale. Non menzionare quanto tempo sono stato assente né usare formule come « bentornato » — salutami in modo naturale e offrimi aiuto per continuare.';
