...
$string['proactive_course_completed'] = 'Ho completato il corso. Congratulati con me';
$string['proactive_default_name'] = 'lì';
$string['proactive_first_visit'] = 'Ciao, mi chiamo {$a->name}. È la prima volta che apro questo corso. Inviami un messaggio di benvenuto.';
$string['proactive_quiz_graded'] = 'Ho completato il quiz «{$a->quizname}» con un voto di {$a->grade}/{$a->maxgrade}.';
$string['proactive_return_visit'] = 'Sto tornando a questo corso dopo {$a}. Dammi il bentornato';
$string['quiz_context_answered'] = '[Risposta quiz di pratica] Domanda {$a->index}/{$a->total}: «{$a->question}». Ho scelto: «{$a->chosen}». Risposta corretta: «{$a->correct}». Ho risposto correttamente: {$a->iscorrect}. Dai un breve feedback — congratulati e spiega se ho avuto ragione, oppure correggi gentilmente e spiega se ho sbagliato. Non passare alla domanda successiva.';
$string['quiz_context_cancelled'] = '[Quiz di pratica annullato] Ho abbandonato il quiz di pratica «{$a->title}» prima della fine. Rassicurami che va bene e che posso esercitarmi quando voglio.';
$string['quiz_context_completed'] = '[Quiz di pratica completato] Ho terminato «{$a->title}» con {$a->score}/{$a->total}. Reagisci brevemente e suggerisci cosa studiare dopo.';
$string['quiz_context_restarted'] = '[Quiz di pratica riavviato] Ho ottenuto {$a->score}/{$a->total} su «{$a->title}» e riprovo dall\'inizio. Incoraggiami brevemente e augurami buona fortuna. NON menzionare, elencare, anticipare o suggerire domande, scelte di risposta o risposte corrette.';
$string['quiz_context_started'] = '[Quiz di pratica avviato] Sto iniziando un quiz di pratica su «{$a->title}» ({$a->count} domande). Rispondi solo con un breve messaggio di buona fortuna. NON menzionare, elencare, anticipare o suggerire domande, scelte di risposta o risposte corrette.';
