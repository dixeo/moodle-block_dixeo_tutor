...
$string['guide_banner_help'] = 'In modalità socratica il tutor pone domande per farti ragionare sull\'argomento invece di dare subito la risposta. Rispondi con parole tue. Se sei in difficoltà, dillo e riceverai un suggerimento. Chiudi questa barra per tornare alla modalità standard.';

$string['guide_banner_help_label'] = 'Informazioni sulla modalità socratica';
...
$string['proactive_guide_started'] = 'L\'allievo è appena entrato in modalità socratica (Guidami). Analizza la conversazione finora e i contenuti di questo corso. Avvia un dialogo socratico su qualsiasi argomento rilevante nel contesto del corso: poni una domanda mirata che richieda una risposta. Non fare una lezione e non dare la risposta completa. Attendi la risposta dell\'allievo.';
