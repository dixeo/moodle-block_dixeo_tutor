...
$string['quiz_review_ai_instructions'] = '[Revisione quiz di pratica] L\'allievo ha completato il quiz di pratica «{$a->title}» con un punteggio migliore di {$a->score}/{$a->total}. Riconosci brevemente il risultato e incoraggialo. Non rivedere le singole domande, non elencare le risposte corrette e non dare feedback su risposte specifiche. Non raccomandare mai questo quiz di pratica né il titolo «{$a->title}» — è generato dal tutor e non è un modulo Moodle. OBBLIGATORIO: la risposta DEVE includere esattamente un passo successivo concreto che nomini un\'attività o una risorsa Moodle esistente copiandone il nome esatto dalla struttura del corso sopra. Non inventare nomi. Non concludere solo con una riga di punteggio.';
