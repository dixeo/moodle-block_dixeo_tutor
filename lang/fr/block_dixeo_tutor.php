...
$string['proactive_return_visit_delighted'] = 'Je poursuis ce cours aujourd\'hui. Envoie-moi un accueil particulièrement chaleureux et enthousiaste — joyeux et motivant. Ne fais aucune référence à mon absence, au temps écoulé ou au fait que je reviens. Concentre-toi sur me saluer et m\'encourager à continuer le cours.';
$string['proactive_return_visit_enthusiastic'] = 'Je poursuis ce cours aujourd\'hui. Envoie-moi un accueil chaleureux et enthousiaste, avec une énergie positive. Ne mentionne pas depuis combien de temps je n\'étais pas là ni n\'utilise de formules du type « bon retour » — salue-moi et aide-moi à reprendre où j\'en étais.';
$string['proactive_return_visit_warm'] = 'Je poursuis ce cours aujourd\'hui. Envoie-moi un accueil bref et chaleureux. Ne mentionne pas mon absence ni n\'utilise de formules du type « bon retour » — salue-moi naturellement et propose de m\'aider à continuer.';
