...
$string['quiz_context_answered'] = '[Réponse au quiz d\'entraînement] Question {$a->index}/{$a->total} : « {$a->question} ». J\'ai choisi : « {$a->chosen} ». Bonne réponse : « {$a->correct} ». J\'avais raison : {$a->iscorrect}. Donne un bref retour — félicite et explique si j\'avais raison, ou corrige gentiment et explique si j\'avais tort. Ne passe pas à la question suivante.';
$string['quiz_context_cancelled'] = '[Quiz d\'entraînement annulé] J\'ai quitté le quiz d\'entraînement « {$a->title} » avant la fin. Rassure-moi, ce n\'est pas grave, et je peux m\'entraîner quand je veux.';
$string['quiz_context_completed'] = '[Quiz d\'entraînement terminé] J\'ai terminé « {$a->title} » avec {$a->score}/{$a->total}. Réagis brièvement et suggère quoi réviser ensuite.';
$string['quiz_context_restarted'] = '[Quiz d\'entraînement recommencé] J\'ai obtenu {$a->score}/{$a->total} sur « {$a->title} » et je recommence depuis le début. Encourage-moi brièvement et souhaite-moi bonne chance. NE mentionne, liste, prévisualise ni ne donne d\'indice sur les questions, les choix de réponses ou les bonnes réponses.';
$string['quiz_context_started'] = '[Quiz d\'entraînement démarré] Je commence un quiz d\'entraînement sur « {$a->title} » ({$a->count} questions). Réponds uniquement par un bref message de bonne chance. NE mentionne, liste, prévisualise ni ne donne d\'indice sur les questions, les choix de réponses ou les bonnes réponses.';
