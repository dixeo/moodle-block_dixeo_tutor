...
$string['quiz_review_ai_instructions'] = '[Revue du quiz d\'entraînement] L\'apprenant a terminé le quiz d\'entraînement « {$a->title} » avec un meilleur score de {$a->score}/{$a->total}. Reconnais brièvement son résultat et encourage-le. Ne passe pas en revue les questions une par une, ne liste pas les bonnes réponses et ne donne pas de feedback sur des réponses précises. Ne recommande jamais ce quiz d\'entraînement ni le titre « {$a->title} » — il est généré par le tuteur et n\'est pas un module Moodle. OBLIGATOIRE : ta réponse DOIT inclure exactement une prochaine étape concrète nommant une activité ou ressource Moodle existante en copiant son nom exact depuis la structure du cours ci-dessus. N\'invente pas de noms. Ne termine pas uniquement par une ligne de score.';
