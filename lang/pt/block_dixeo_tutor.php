...
$string['proactive_return_visit_delighted'] = 'Estou a continuar esta disciplina hoje. Envia-me uma saudação especialmente calorosa e entusiasta — alegre e motivadora. Não faças referência à minha ausência, ao tempo passado ou ao facto de estar a voltar. Concentra-te em cumprimentar-me e encorajar-me a continuar a disciplina.';
$string['proactive_return_visit_enthusiastic'] = 'Estou a continuar esta disciplina hoje. Envia-me uma saudação calorosa e animada, com energia positiva. Não menciones quanto tempo estive ausente nem uses frases como « bem-vindo de volta » — cumprimenta-me e ajuda-me a retomar onde parei.';
$string['proactive_return_visit_warm'] = 'Estou a continuar esta disciplina hoje. Envia-me uma saudação breve e amigável. Não menciones quanto tempo estive ausente nem uses frases como « bem-vindo de volta » — cumprimenta-me naturalmente e oferece ajuda para continuar.';
