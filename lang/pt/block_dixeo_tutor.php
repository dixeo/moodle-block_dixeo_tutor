...
$string['guide_banner_help'] = 'No modo socrático, o tutor faz perguntas para o ajudar a raciocinar o tema em vez de dar a resposta de imediato. Responda por palavras suas. Se estiver bloqueado, diga-o e receberá uma dica. Feche esta barra para voltar ao modo padrão.';
$string['guide_banner_help_label'] = 'Acerca do modo socrático';
...
$string['proactive_guide_started'] = 'O aluno acabou de entrar no modo socrático (Guia-me). Analisa a conversa até agora e o conteúdo desta disciplina. Inicia um diálogo socrático sobre qualquer tópico relevante no contexto da disciplina: faz uma pergunta focada que exija resposta. Não dês uma aula nem a resposta completa. Espera pela resposta do aluno.';
...
$string['quiz_review_ai_instructions'] = '[Revisão do questionário de prática] Terminei o questionário de prática «{$a->title}» com uma melhor pontuação de {$a->score}/{$a->total}. Usa os resultados estruturados das perguntas nesta mensagem. Parabeniza-me se me saí bem. Se a minha pontuação foi baixa ou falhei perguntas, sê compreensivo e encorajador — ajuda-me a manter a motivação. Sugere tópicos ou material do curso para rever e colmatar lacunas de conhecimento, e recomenda próximos passos concretos. Mantém a resposta focada e útil.';
