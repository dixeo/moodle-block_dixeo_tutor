...
$string['proactive_guide_started'] = 'O aluno acabou de entrar no modo socrático (Guia-me). Indicou do que precisa de ajuda: «{$a->userprompt}». Resuma em guideTopic.title e guideTopic.description. Inicia um diálogo socrático focado nessa necessidade com o conteúdo da disciplina: faz uma pergunta focada que exija resposta. Não dês uma aula nem a resposta completa. Espera pela resposta do aluno.';
...
$string['quiz_review_ai_instructions'] = '[Revisão do questionário de prática] O aluno terminou o questionário de prática «{$a->title}» com uma melhor pontuação de {$a->score}/{$a->total}. Reconhece brevemente o resultado e encoraja-o. Não revejas perguntas individuais, não listes respostas corretas nem dês feedback sobre respostas específicas. Nunca recomendes este questionário de prática nem o título «{$a->title}» — é gerado pelo tutor e não é um módulo Moodle. OBRIGATÓRIO: a tua resposta DEVE incluir exatamente um próximo passo concreto que nomeie uma atividade ou recurso Moodle existente copiando o nome exato da estrutura da disciplina acima. Não inventes nomes. Não termines apenas com uma linha de pontuação.';
