...
$string['privacy:metadata'] = 'The Dixeo Student Tutor block does not store personal data in the Moodle database. Tutor conversations are processed by local_dixeo and transferred to the Dixeo API. Retention, export, and deletion of those conversations are governed by local_dixeo and the site\'s agreement with the Dixeo service, not by this block.';
