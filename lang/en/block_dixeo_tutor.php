...
$string['guide_banner_help'] = 'In Socratic Mode, the tutor asks questions to help you reason through the topic instead of giving the answer first. Reply in your own words. If you are stuck, say so and you will get a hint. Close this bar to return to Standard mode.';
$string['guide_banner_help_label'] = 'About Socratic Mode';
...
$string['proactive_guide_started'] = 'The learner just entered Socratic (Guide me) mode. Analyze the conversation so far and this course\'s content. Start a Socratic dialogue on any relevant topic in the course context: ask one focused question that requires a response. Do not lecture or give the full answer. Wait for the learner to reply.';
...
$string['teach_setup_prompt_required'] = 'Please describe what you want to learn.';
