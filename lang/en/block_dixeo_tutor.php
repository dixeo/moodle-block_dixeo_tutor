...
$string['quiz_context_answered'] = '[Practice quiz answer] Question {$a->index}/{$a->total}: "{$a->question}". I chose: "{$a->chosen}". Correct answer: "{$a->correct}". I was correct: {$a->iscorrect}. Give brief feedback — congratulate and explain if I was right, or gently correct and explain if I was wrong. Do not start the next question.';
$string['quiz_context_cancelled'] = '[Practice quiz cancelled] I exited the practice quiz "{$a->title}" early. Reassure me that is fine and I can practice anytime.';
$string['quiz_context_completed'] = '[Practice quiz completed] I finished "{$a->title}" with {$a->score}/{$a->total}. React briefly and suggest what to study next.';
$string['quiz_context_restarted'] = '[Practice quiz restart] I scored {$a->score}/{$a->total} on "{$a->title}" and I am trying again from the beginning. Encourage me briefly and wish me luck. Do NOT mention, list, preview, or hint at any questions, answer choices, or correct answers.';
$string['quiz_context_started'] = '[Practice quiz started] I am starting a practice quiz on "{$a->title}" ({$a->count} questions). Reply with a brief good-luck message only. Do NOT mention, list, preview, or hint at any questions, answer choices, or correct answers.';
