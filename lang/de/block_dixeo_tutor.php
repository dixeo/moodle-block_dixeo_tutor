...
$string['guide_banner_help'] = 'Im sokratischen Modus stellt der Tutor Fragen, damit Sie das Thema selbst durchdenken, statt sofort die Antwort zu erhalten. Antworten Sie in eigenen Worten. Wenn Sie nicht weiterkommen, sagen Sie es – dann erhalten Sie einen Hinweis. Schließen Sie diese Leiste, um zum Standardmodus zurückzukehren.';

$string['guide_banner_help_label'] = 'Über den sokratischen Modus';
...
$string['proactive_guide_started'] = 'Der Lernende hat gerade den sokratischen Modus (Begleite mich) betreten. Analysiere den bisherigen Gesprächsverlauf und den Inhalt dieses Kurses. Starte einen sokratischen Dialog zu einem relevanten Thema im Kurskontext: stelle eine gezielte Frage, die eine Antwort erfordert. Halte keinen Vortrag und gib nicht die vollständige Antwort. Warte auf die Antwort des Lernenden.';
