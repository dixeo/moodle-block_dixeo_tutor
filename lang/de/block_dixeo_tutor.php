...
$string['quiz_review_ai_instructions'] = '[Übungsquiz-Auswertung] Der Lernende hat das Übungsquiz „{$a->title}“ mit einer besten Punktzahl von {$a->score}/{$a->total} abgeschlossen. Würdige das Ergebnis kurz und ermutige ihn. Bewerte keine einzelnen Fragen, liste keine richtigen Antworten auf und gib kein Feedback zu konkreten Antworten. Empfehle niemals dieses Übungsquiz oder den Titel „{$a->title}“ — es ist tutor-generiert und kein Moodle-Kursmodul. PFLICHT: Deine Antwort MUSS genau einen konkreten nächsten Schritt enthalten, der eine bestehende Moodle-Kursaktivität oder -ressource nennt, indem du ihren genauen Namen aus der Kursstruktur oben übernimmst. Erfinde keine Namen. Beende die Antwort nicht nur mit einer Punktzahlzeile.';
