...
$string['quiz_context_answered'] = '[Übungsquiz-Antwort] Frage {$a->index}/{$a->total}: „{$a->question}“. Ich habe gewählt: „{$a->chosen}“. Richtige Antwort: „{$a->correct}“. Ich lag richtig: {$a->iscorrect}. Gib kurzes Feedback — gratuliere und erkläre, wenn ich richtig lag, oder korrigiere freundlich und erkläre, wenn ich falsch lag. Beginne nicht mit der nächsten Frage.';
$string['quiz_context_cancelled'] = '[Übungsquiz abgebrochen] Ich habe das Übungsquiz „{$a->title}“ vorzeitig beendet. Beruhige mich, dass das in Ordnung ist und ich jederzeit üben kann.';
$string['quiz_context_completed'] = '[Übungsquiz abgeschlossen] Ich habe „{$a->title}“ mit {$a->score}/{$a->total} abgeschlossen. Reagiere kurz und schlage vor, was als Nächstes gelernt werden sollte.';
$string['quiz_context_restarted'] = '[Übungsquiz neu gestartet] Ich habe {$a->score}/{$a->total} bei „{$a->title}“ erreicht und beginne von vorne. Ermutige mich kurz und wünsche mir Glück. Erwähne, liste, zeige Vorschauen oder gib KEINE Hinweise zu Fragen, Antwortoptionen oder richtigen Antworten.';
$string['quiz_context_started'] = '[Übungsquiz gestartet] Ich beginne ein Übungsquiz zu „{$a->title}“ ({$a->count} Fragen). Antworte nur mit einer kurzen Glückwunsch-Nachricht. Erwähne, liste, zeige Vorschauen oder gib KEINE Hinweise zu Fragen, Antwortoptionen oder richtigen Antworten.';
